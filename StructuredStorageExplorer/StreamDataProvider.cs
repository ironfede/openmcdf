...
public class StreamDataProvider : IByteProvider
{
    ...
    /// Modifying stream
    /// </summary>
    readonly CfbStream _modifiedStream;
    ...
    public StreamDataProvider(CfbStream modifiedStream)
    {
        byte[] data = new byte[modifiedStream.Length];
        modifiedStream.Position = 0;
        modifiedStream.ReadExactly(data, 0, data.Length);
    ...
    public void ApplyChanges()
    {
        ...
        _modifiedStream.Write(Bytes.ToArray());
    }
