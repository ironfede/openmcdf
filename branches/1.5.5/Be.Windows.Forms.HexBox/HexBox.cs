...
namespace Be.Windows.Forms
{
	...
	public class HexBox : Control
	{
		...
		void CreateCaret()
		{
			...
			ManagedCaretMethods.CreateCaret(this, caretWidth, caretHeight);

			UpdateCaret();

            ManagedCaretMethods.ShowCaret(this);
		...
		void UpdateCaret()
		{
			...
			ManagedCaretMethods.SetCaretPos((int)p.X, (int)p.Y);
		}
		...
		void DestroyCaret()
		{
			...
			ManagedCaretMethods.DestroyCaret();
			_caretVisible = false;
		}
		...
		public override bool PreProcessMessage(ref Message m)
		{
			switch (m.Msg)
			{
				case ManagedCaretMethods.WM_KEYDOWN:
					return _keyInterpreter.PreProcessWmKeyDown(ref m);
				case ManagedCaretMethods.WM_CHAR:
					return _keyInterpreter.PreProcessWmChar(ref m);
				case ManagedCaretMethods.WM_KEYUP:
