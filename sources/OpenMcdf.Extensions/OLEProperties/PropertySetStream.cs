    ...
    internal class PropertySetStream
    {
        ...
        public void Read(BinaryReader br)
        {
            ...
            for (var i = 0; i < PropertySet0.NumProperties; i++)
            {
                ...
                PropertySet0.Properties.Add(ReadProperty(
                    PropertySet0.PropertyIdentifierAndOffsets[i].PropertyIdentifier,
                    PropertySet0.PropertyContext.CodePage, br));
            }
            ...
            if (NumPropertySets == 2)
            {
                ...
                for (var i = 0; i < PropertySet1.NumProperties; i++)
                {
                    ...
                    PropertySet1.Properties.Add(ReadProperty(
                        PropertySet1.PropertyIdentifierAndOffsets[i].PropertyIdentifier,
                        PropertySet1.PropertyContext.CodePage, br));
                }
            }
        }
        ...
        private class OffsetContainer
        {
            ...
            public List<long> PropertyIdentifierOffsets { get; }
            public List<long> PropertyOffsets { get; }
        }
    }
}