namespace OpenMcdf.Extensions.OLEProperties
{
    public enum VTPropertyType : ushort
    {
        ...
        VT_STREAM = 0x0042, // MUST be an IndirectPropertyName. The storage representing the (non-simple)
                            // property set MUST have a stream element with this name. 
        VT_STORAGE = 0x0043, // MUST be an IndirectPropertyName. The storage representing the (non-simple)
                             // property set MUST have a storage element with this name. 
        VT_STREAMED_OBJECT = 0x0044, // MUST be an IndirectPropertyName. The storage representing the (non-simple)
                                     // property set MUST have a stream element with this name. 
        VT_STORED_OBJECT = 0x0045, // MUST be an IndirectPropertyName. The storage representing the (non-simple)
                                   // property set MUST have a storage element with this name. 
