...
namespace OpenMcdf
{
    ...
    public class CFStream : CFItem
    {
        ...
        ///     begin copying bytes to the current <see cref="T:OpenMcdf.CFStream">CFStream</see>.
        /// </param>
        /// <param name="count">
        ///     The number of bytes to be written to the current <see cref="T:OpenMcdf.CFStream">CFStream</see>
        /// </param>
        /// <remarks>
        ///     Current stream will be extended to receive data buffer over
        ///     its current size.
        ...
        /// <param name="position">
        ///     The zero-based byte position in the stream at which to begin reading
        ///     the data from.
        /// </param>
