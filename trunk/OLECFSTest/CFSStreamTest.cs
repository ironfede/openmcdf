...
namespace OLECFSTest
{
    ...
    public class CFSStreamTest
    {
        ...
        public void Test_WRITE_STREAM_WITH_DIFAT()
        {
            ...
            cf.Save(OUTPUT_DIR + "WRITE_STREAM_WITH_DIFAT.cfs");
            cf.Close();


            CompoundFile cf2 = new CompoundFile(OUTPUT_DIR + "WRITE_STREAM_WITH_DIFAT.cfs");
        ...
        public void Test_WRITE_MINISTREAM_READ_REWRITE_STREAM()
        {
            ...
            cfa.Save(OUTPUT_DIR + "WRITE_MINISTREAM_READ_REWRITE_STREAM.cfs");

            cfa.Close();

            // Now get the second stream and rewrite it smaller
            byte[] bb = GetBuffer(MEGA_SIZE);
            CompoundFile cfb = new CompoundFile(OUTPUT_DIR + "WRITE_MINISTREAM_READ_REWRITE_STREAM.cfs");
            ...
            cfb.Save(OUTPUT_DIR + "WRITE_MINISTREAM_READ_REWRITE_STREAM_2ND.cfs");
            cfb.Close();

            CompoundFile cfc = new CompoundFile(OUTPUT_DIR + "WRITE_MINISTREAM_READ_REWRITE_STREAM_2ND.cfs");
        ...
        public void Test_RE_WRITE_SMALLER_MINI_STREAM()
        {
            ...
            cf.Save(OUTPUT_DIR + "RE_WRITE_SMALLER_MINI_STREAM.xls");
            cf.Close();
        }
        ...
        //    cf.Save(OUTPUT_DIR + "MultipleStorage_REMOVED_STREAM_1.cfs");
        //    cf.Close();
        //}
        ...
        //    cf.Save(OUTPUT_DIR + "MultipleStorage_REMOVED_STREAM_2.cfs");
        ...
        private void SingleWriteReadMatching(int size)
        {
            ...
            String filename = OUTPUT_DIR + "INCREMENTAL_SIZE_MULTIPLE_WRITE_AND_READ_CFS.cfs";
